...
const ANALYST_INSTRUCTIONS = [
  ...
  '  retrieved.',
  '- When more than one relevant news development is available, prioritize the newest dated',
  '  development. Do not favor an older N: News Hub item over a newer W: Tavily item solely',
  '  because of its source prefix.',
